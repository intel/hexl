...
/// @brief Radix-2 native C++ DWT implementation of the forward DWT
/// @param[out] result Output data. Overwritten with DWT output
...
void Forward_DWT_ToBitReverseRadix2(
...
/// @brief Radix-2 native C++ DWT implementation of the inverse DWT
/// @param[out] result Output data. Overwritten with DWT output
/// @param[in] operand Input data.
/// @param[in] n Size of the transform, i.e. the polynomial degree. Must be a
/// power of two.
...
/// @param[in] scale Scale applied to output data
void Inverse_DWT_FromBitReverseRadix2(
    std::complex<double>* result, const std::complex<double>* operand,
