...
inline void LoadFwdComplexInterleavedT1(const double_t* arg, __m512d* out1,
                                        __m512d* out2) {
  const __m512i vperm_idx = _mm512_set_epi64(6, 7, 4, 5, 2, 3, 0, 1);
...
inline void LoadFwdComplexInterleavedT2(const double_t* arg, __m512d* out1,
                                        __m512d* out2) {
  const __m512d* arg_512 = reinterpret_cast<const __m512d*>(arg);
...
inline void LoadFwdComplexInterleavedT4(const double_t* arg, __m512d* out1,
                                        __m512d* out2) {
  const __m512d* arg_512 = reinterpret_cast<const __m512d*>(arg);
...
inline void WriteFwdComplexInterleavedT1(__m512d arg1, __m512d arg2,
                                         __m512d* out) {
  const __m512i vperm_4hi_4lo_idx = _mm512_set_epi64(3, 2, 1, 0, 7, 6, 5, 4);
  const __m512i v_X_out_idx = _mm512_set_epi64(3, 7, 2, 6, 1, 5, 0, 4);
  const __m512i v_Y_out_idx = _mm512_set_epi64(7, 3, 6, 2, 5, 1, 4, 0);
