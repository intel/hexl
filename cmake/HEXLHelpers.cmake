...
function(add_compiler_definition target)
  if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    target_compile_definitions(${target} PUBLIC HEXL_USE_MSVC)
  elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    target_compile_definitions(${target} PUBLIC HEXL_USE_GNU)
  elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    message("target ${target} setting HEXL_USE_CLANG")
    target_compile_definitions(${target} PUBLIC HEXL_USE_CLANG)
  else()
