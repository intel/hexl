...
void EltwiseMultModAVX512DQIntLoopUnroll(__m512i* vp_result,
  ...
  ThreadPoolExecutor::AddParallelJobs(loop_count, [=](size_t start,
    ...
    for (size_t i = start; i < end; ++i) {
      __m512i x1 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y1 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x2 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y2 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x3 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y3 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x4 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y4 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x5 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y5 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x6 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y6 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x7 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y7 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x8 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y8 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x9 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y9 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x10 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y10 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x11 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y11 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x12 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y12 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x13 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y13 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x14 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y14 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x15 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y15 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i x16 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i y16 = _mm512_loadu_si512(in_vp_operand2++);
      ...
      vr1 = _mm512_hexl_small_mod_epu64<4>(vr1, v_modulus, &in_v_twice_mod);
      vr2 = _mm512_hexl_small_mod_epu64<4>(vr2, v_modulus, &in_v_twice_mod);
      vr3 = _mm512_hexl_small_mod_epu64<4>(vr3, v_modulus, &in_v_twice_mod);
      vr4 = _mm512_hexl_small_mod_epu64<4>(vr4, v_modulus, &in_v_twice_mod);
      vr5 = _mm512_hexl_small_mod_epu64<4>(vr5, v_modulus, &in_v_twice_mod);
      vr6 = _mm512_hexl_small_mod_epu64<4>(vr6, v_modulus, &in_v_twice_mod);
      vr7 = _mm512_hexl_small_mod_epu64<4>(vr7, v_modulus, &in_v_twice_mod);
      vr8 = _mm512_hexl_small_mod_epu64<4>(vr8, v_modulus, &in_v_twice_mod);
      vr9 = _mm512_hexl_small_mod_epu64<4>(vr9, v_modulus, &in_v_twice_mod);
      vr10 = _mm512_hexl_small_mod_epu64<4>(vr10, v_modulus, &in_v_twice_mod);
      vr11 = _mm512_hexl_small_mod_epu64<4>(vr11, v_modulus, &in_v_twice_mod);
      vr12 = _mm512_hexl_small_mod_epu64<4>(vr12, v_modulus, &in_v_twice_mod);
      vr13 = _mm512_hexl_small_mod_epu64<4>(vr13, v_modulus, &in_v_twice_mod);
      vr14 = _mm512_hexl_small_mod_epu64<4>(vr14, v_modulus, &in_v_twice_mod);
      vr15 = _mm512_hexl_small_mod_epu64<4>(vr15, v_modulus, &in_v_twice_mod);
      vr16 = _mm512_hexl_small_mod_epu64<4>(vr16, v_modulus, &in_v_twice_mod);

      _mm512_storeu_si512(in_vp_result++, vr1);
      _mm512_storeu_si512(in_vp_result++, vr2);
      _mm512_storeu_si512(in_vp_result++, vr3);
      _mm512_storeu_si512(in_vp_result++, vr4);
      _mm512_storeu_si512(in_vp_result++, vr5);
      _mm512_storeu_si512(in_vp_result++, vr6);
      _mm512_storeu_si512(in_vp_result++, vr7);
      _mm512_storeu_si512(in_vp_result++, vr8);
      _mm512_storeu_si512(in_vp_result++, vr9);
      _mm512_storeu_si512(in_vp_result++, vr10);
      _mm512_storeu_si512(in_vp_result++, vr11);
      _mm512_storeu_si512(in_vp_result++, vr12);
      _mm512_storeu_si512(in_vp_result++, vr13);
      _mm512_storeu_si512(in_vp_result++, vr14);
      _mm512_storeu_si512(in_vp_result++, vr15);
      _mm512_storeu_si512(in_vp_result++, vr16);
    }
  });
}
...
inline void EltwiseMultModAVX512FloatLoopUnroll(
  ...
  ThreadPoolExecutor::AddParallelJobs(loop_count, [=](size_t start,
    ...
    HEXL_LOOP_UNROLL_4
    for (size_t i = start; i < end; ++i) {
      __m512i op1_1 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i op1_2 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i op1_3 = _mm512_loadu_si512(in_vp_operand1++);
      __m512i op1_4 = _mm512_loadu_si512(in_vp_operand1++);

      __m512i op2_1 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i op2_2 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i op2_3 = _mm512_loadu_si512(in_vp_operand2++);
      __m512i op2_4 = _mm512_loadu_si512(in_vp_operand2++);
      ...
      _mm512_storeu_si512(in_vp_result++, v_out_1);
      _mm512_storeu_si512(in_vp_result++, v_out_2);
      _mm512_storeu_si512(in_vp_result++, v_out_3);
      _mm512_storeu_si512(in_vp_result++, v_out_4);
    }
  });
}
...
void EltwiseMultModAVX512Float(uint64_t* result, const uint64_t* operand1,
  ...
  if (uint64_t n_mod_8 = n % 8; n_mod_8 != 0) {
    EltwiseMultModNative<InputModFactor>(result, operand1, operand2, n_mod_8,
                                         modulus);
    operand1 += n_mod_8;
    operand2 += n_mod_8;
