...
TEST(DWT, BuildFloatingPoints_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
  {
...
TEST(DWT, ComplexLoadFwdInterleavedT1_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexWriteFwdInterleavedT1_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexLoadInvInterleavedT1_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexLoadFwdInterleavedT2_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexLoadInvInterleavedT2_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexLoadFwdInterleavedT4_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexLoadInvInterleavedT4_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexWriteInvInterleavedT4_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
// Re-arrange 1 complex interleaved into 8 complex interleaved
TEST(DWT, ComplexLoadFwdInterleavedT8_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ComplexWriteInvInterleavedT8_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
...
TEST(DWT, ForwardInverseDWT_AVX512) {
  if (!has_avx512dq) {
    GTEST_SKIP();
  }
